...
// Get list of files
// @ts-ignore
const files = import.meta.glob('../powerpoint/*', { eager: true, query: '?url', import: 'default' });
                ...
                <div className="container mx-auto px-4">
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground mt-2 ml-14">
                            Bộ slide bài giảng được thiết kế chuyên nghiệp, sinh động.
                        </p>
                    </div>
                    ...
                    {fileList.length > 0 ? (
                        ...
                        <div className="text-center py-20 bg-white rounded-xl border border-dashed">
                            ...
                            <h3 className="text-lg font-semibold text-slate-900">Chưa có slide nào</h3>
